...
################ VERIFICA QUE LAS PASS SE ALMCENA EN FORMATO HASH ##########################
...
################## VERIFICA QUE LOS USUARIOS HAYA PROPORCIONADO PASS CORRECTA ###############
